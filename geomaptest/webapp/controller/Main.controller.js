sap.ui.define([
	...
	AnalyticMap.GeoJSONURL = "/model/kr.json";
	//AnalyticMap.GeoJSONURL = "https://sapui5.hana.ondemand.com/test-resources/sap/ui/vbm/demokit/media/analyticmap/L1_US.json";

	return Controller.extend("sap.ui.vbm.sample.AnalyticMapRegions.Main", {

		onInit: function() {
			var oModel = new JSONModel("/model/Data1.json");
			// var oModel = new JSONModel("https://sapui5.hana.ondemand.com/test-resources/sap/ui/vbm/demokit/sample/AnalyticMapRegions/Data.json");
            debugger;
			...
			oModel.attachRequestCompleted(function(oEvent) {
				// for (var i = 0; i <= 50; i++) {
					...
					// if (birthRate >= 15) {
						oModel.setProperty("/Regions/" + 0 + "/color", "rgb(27,126,172)");
